...
func runClaude(cmd *cobra.Command, args []string) error {
	...
	// the profile's pinned model (see defaults/profiles.json). The pinned
	// value is a Claude Code model alias and may need to be updated when
	// Anthropic releases a new model family.
